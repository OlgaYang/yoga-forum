...
import { ImplementableInterfaceRef, InterfaceRef } from '@pothos/core';
import { dataloaderGetter } from '../util.js';
export class LoadableInterfaceRef extends InterfaceRef {
    constructor(name, getDataloader) {
        super(name), _define_property(this, "getDataloader", void 0);
        this.getDataloader = getDataloader;
    }
}
export class ImplementableLoadableInterfaceRef extends ImplementableInterfaceRef {
    implement(options) {
    ...
    constructor(builder, name, { loaderOptions, load, toKey, sort, cacheResolved }) {
        super(builder, name), _define_property(this, "cacheResolved", void 0), _define_property(this, "getDataloader", void 0);
