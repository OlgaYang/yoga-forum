...
fieldBuilderProto.loadable = function loadable({ load, sort, loaderOptions, resolve, type, byPath, ...options }) {
    const getLoader = pathDataloaderGetter(loaderOptions, (keys, ctx, args, info) => load(keys, ctx, args, info), undefined, sort, byPath);
    return this.field({
        ...options,
        type,
...
fieldBuilderProto.loadableGroup = function loadableGroup({ load, group, loaderOptions, byPath, resolve, type, ...options }) {
    const getLoader = pathDataloaderGetter(loaderOptions, async (keys, ctx, args, info) => {
